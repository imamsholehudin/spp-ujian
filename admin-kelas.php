                  ...
                  <table class ="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="admin-kelas-edit.php?id=<?php echo $kelas['id_kelas'];?>"><button type="button" class="btn btn-primary">Edit</button></a>
                          <a href="admin_kelas_hapus.php?id=<?php echo $kelas['id_kelas'];?>"><button type="button" class="btn btn-danger">Hapus</button></a>
                        </td>
                      </tr>
                        <?php } ?>
                    </tbody>
