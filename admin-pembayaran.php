...
<?php 
  ...
  $query = mysqli_query($mysqli,"select * from pembayaran");
?>
<html lang="en">
                  ...
                  <table class ="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td> <?php echo $bayar['id_petugas'];?> </td>
                        <td> <?php echo $bayar['tgl_bayar'];?> </td>
                        <td> <?php echo $bayar['bulan_dibayar']."-".$bayar["tahun_dibayar"];?> </td>
                        <td>
                          <?php echo $bayar["jumlah_bayar"];?>
                        </td>
                      </tr>
                        <?php } ?>
                    </tbody>
